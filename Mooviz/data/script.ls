...
planet.position = Vector2.{ 0.5, 0.5 } + ellipse(cycle, 2, 1, 3.0/8.0) * Vector2.{ radius/2.0, radius };
...
for 1..10 {
    ...
    trail := Vector2.{ 0.5, 0.5 } + ellipse(lerp, 2, 1, 3.0/8.0) * Vector2.{ radius/2.0, radius };
